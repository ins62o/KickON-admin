...
import { playerHref } from "@/lib/football/config";
...
export function PlayerRankings({ players }: { players: PlayerRankingRecord[] }) {
  ...
  const teams = Array.from(new Map(players.map((player) => [player.teamId, {
    id: player.teamId,
