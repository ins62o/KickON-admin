...
export function StatusBadge({ status, label, className }: { status: HealthStatus; label?: string; className?: string }) {
  const config = statusConfig[status];
  return (
    <Badge variant="outline" className={cn("h-6 gap-1.5 rounded-md px-2 text-xs font-medium", config.className, className)}>
