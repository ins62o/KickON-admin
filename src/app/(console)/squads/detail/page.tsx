  ...
  return (
    <div className="mx-auto w-full max-w-[1720px] px-4 py-6 lg:px-6 lg:py-7">
      ...
      <main className="mt-6 space-y-6">
        {canOverride && player.id.startsWith("manual_") ? <details className="rounded-xl border border-border p-5"><summary className="cursor-pointer text-sm font-semibold">공급자 선수와 병합</summary><ManualPlayerMergeForm player={player} candidates={result.candidates} /></details> : null}
