import { parseSupabaseProjectMetrics } from "../../src/lib/supabase/prometheus-parser.ts";
...
export async function getSupabaseProjectMetrics(): Promise<SupabaseProjectMetrics> {
